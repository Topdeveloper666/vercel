...
export default function Blog({ bloglist, blogSingle }) {

  const [item, setItem] = useState(blogSingle.blogs[0]);
  ...
  return (
    <>
      <Head>
        ...
        <meta name="title" content={item.post_title} data-react-helmet="true"></meta>

        <meta name="description" content={item.meta_content} data-react-helmet="true"></meta>

        <meta name="keywords" content={item.post_tags} data-react-helmet="true"></meta>
              ...
              <div className="col-lg-5 social">
                <div className="">
                  <ul>
                    <li>
                      <a
                        href={`https://www.facebook.com/sharer/sharer.php?u=${Global.BASE_APP_PATH}/blogs/${item.post_title}`}
                        target="_blank"
                        rel="noreferrer"
                      >
                        <svg
                    ...
                    <li>
                      <a
                        href={`https://twitter.com/intent/tweet?text=${Global.BASE_APP_PATH}/blogs/${item.post_title}&title=${item.post_title}`}
                        target="_blank"
                        rel="noreferrer"
                      >
                        <svg
                      ...
                      return (
                        ...
                        >
                          <div className="img-box">
                            <img src={e.image_url} alt="blog_img" />
                          </div>
...
export const getServerSideProps = async (context) => {
  ...
  try {
    ...
    const url1 = Global.BASE_API_PATH + `/blogs-details/${id}`;
    ...
    const blogSingle = await res1.json();
