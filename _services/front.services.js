...
async function addressList(id, addressId) {
  const data = {
    user_id: id,
...
async function getBookingSlots(data) {
  const requestOptions = {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(data),
  };
  return fetch(Global.BASE_API_PATH + `/booking-slots`, requestOptions)
    .then(handleResponse)
    .then((res) => {
      return res;
    });
...
async function getAvailableBookingSlots(data) {
  const requestOptions = {
    method: "GET",
    headers: { "Content-Type": "application/json" },
  };
...
async function getCashBackOffers(user_id) {
  const requestOptions = {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({ user_id }),
  };
  return fetch(Global.BASE_API_PATH + `/cashback`, requestOptions)
    .then(handleResponse)
    .then((res) => {
      return res;
    });
...
async function getUserWalletDetail(user_id) {
  const requestOptions = {
    method: "GET",
    headers: { "Content-Type": "application/json" },
  };
...
async function changeScratchValueForId(cashbackID, value) {
  const requestOptions = {
    method: "GET",
    headers: { "Content-Type": "application/json" },
  };
  return fetch(
    Global.BASE_API_PATH + `/scratch-card/${cashbackID}/${value}`,
    requestOptions
  )
    .then(handleResponse)
    .then((res) => {
...
async function addressDeleteByIdAndUserId(id, user_id) {
  const requestOptions = {
    method: "POST",
    headers: { "Content-Type": "application/json" },
